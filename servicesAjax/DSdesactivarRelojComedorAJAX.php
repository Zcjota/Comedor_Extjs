...
if (isset($codigo)) {
    ...
    $codigo = mysqli_real_escape_string($conex, $codigo); // Escapa el valor del código para evitar inyecciones SQL

    $sql = "UPDATE `reloj_comedor` SET ACTIVO = 0 WHERE COD_RELOJ = $codigo";
