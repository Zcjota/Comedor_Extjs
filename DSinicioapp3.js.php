...
?>
    ...
    Ext.dsdata.PAcentral = new Ext.TabPanel({
					...
					items: [ 	
					{
						xtype: 'iframepanel',    
						id : 'TABcentral',    
						title :  "<FONT FACE=ARIAL  SIZE=0><b style = color:#15428B; >Información</b></FONT>",    
						loadMask  : true,    				  	
	...
	var FNcentralclick = function(node) {	
				...
				var j=0;
				 if(ids=="s15")
					{
						var g="<FONT FACE=ARIAL  SIZE=0><b style = color:#15428B; >Retrasos / Faltas (Sin Revision) </b></FONT>";
						j=1;
					}
					if(ids=="s45")
					{
						var g="<FONT FACE=ARIAL  SIZE=0><b style = color:#15428B; >Horas Extras* (Aprobacion)</b></FONT>";
						j=1;
					}
					if(ids=="s24")
					{
						var g="<FONT FACE=ARIAL  SIZE=0><b style = color:#15428B; >Bandeja (Borradores)</b></FONT>";
						j=1;
					}
					if(ids=="s25")
					{
						var g="<FONT FACE=ARIAL  SIZE=0><b style = color:#15428B; >Bandeja (Revisores)</b></FONT>";
						j=1;
					}
					if(ids=="s29")
					{
						var g="<FONT FACE=ARIAL  SIZE=0><b style = color:#15428B; >Bandeja (Rechazado)</b></FONT>";
						j=1;
					}
					if(ids=="s26")
					{
						var g="<FONT FACE=ARIAL  SIZE=0><b style = color:#15428B; >Pendientes de Aprobacion</b></FONT>";
						j=1;
					}
					if(j==0)
					{
  ...
  return false;
				...
				//aprobaciones pendientes
				 ...
				 var ch2 = Ext.getCmp('c26'); 
				  if(pendiente=="0"){
						...
						if (empty(chx) != true) {
							lrx='<b style =color:#15428B><font size=1>Aprobaciones </font></b>';
							chx.setTitle(lrx);
						}
						if (empty(ch2) != true) {
							 lr='<a style ="color:#15428B; font: bold 8.5px tahoma,arial,verdana,sans-serif;">Pendientes de </br>Aprobacion ['+pendiente+']</a>';
							ch2.setText(lr);
						}
						...
						if (empty(chx) != true) {
							lr='<FONT FACE=ARIAL  SIZE=0><b style = "color:#15428B"; >Pendientes de Aprobacion ['+pendiente+']</b></FONT>';
							 chx.setText(lr);
						}
				 ...
				 if (empty(ch3) != true) {
					 lr='<a style ="color:#15428B; font: bold 8.5px tahoma,arial,verdana,sans-serif;">Bandeja </br>(Borradores) ['+borradores+']</a>';
					ch3.setText(lr);
				 }
				 ...
				 var ch4 = Ext.getCmp('c29'); 
					...
					if (empty(ch4) != true) {
						lr='<a style ="color:#15428B; font: bold 8.5px tahoma,arial,verdana,sans-serif;">Bandeja </br>(Rechazado) ['+rechazado+']</a>';
						 ch4.setText(lr);
					}
				 ...
				 if(horas=="0"){
					if (empty(choras) != true) {
						 lr='<a style ="color:#15428B; font: bold 8.5px tahoma,arial,verdana,sans-serif;">Horas Extras </br>(Aprobacion)</a>';
						choras.setText(lr);
					}
					 var chx = Ext.getCmp('Me6'); 
					if (empty(chx) != true) {
						lrx='<b style =color:#15428B><font size=1>Control de Asistencia </font></b>';
						chx.setTitle(lrx);
					}
					   var chx = Ext.getCmp('MENU6'); 	
						...
						if (empty(chx) != true) {
							lr='<FONT FACE=ARIAL  SIZE=0><b style = "color:#15428B"; >Horas Extras(Aprobacion)</b></FONT>';
							 chx.setText(lr);
						}
				 ...
				 if(borradorSinLeer =="0"){
					...
					if (empty(chx) != true) {
						lrx='<b style =color:#15428B><font size=1>Bandejas </font></b>';
						chx.setTitle(lrx);
					}
					 var chx = Ext.getCmp('MENU9'); 	
						...
						if (empty(chx) != true) {
							lr='<FONT FACE=ARIAL  SIZE=0><b style = "color:#15428B"; >Bandeja (Borradores) ['+borradores+']</b></FONT>';
							 chx.setText(lr);
						}
				 ...
				 if(rechazadoSinLeer =="0"){
					...
					if(borradorSinLeer=="0"){
					 ...
					 var chx = Ext.getCmp('MENU9'); 	
						...
						if (empty(chx) != true) {
							lr='<FONT FACE=ARIAL  SIZE=0><b style = "color:#15428B"; >Bandeja (Rechazado) ['+rechazado+']</b></FONT>';
							 chx.setText(lr);
						}
				 }
				 else
				 ...
				 if(total_sin_revision=="0" ){
				  var ch1 = Ext.getCmp('c15'); 
					if (empty(ch1) != true) {
						lr='<a style ="color:#15428B; font: bold 8.5px tahoma,arial,verdana,sans-serif;"> Faltas </br>(Sin Revision) ['+total_sin_revision+']</a>';
						ch1.setText(lr);
					}
					var chx = Ext.getCmp('Me6'); 
					...
					if (empty(chx) != true) {
						lr='<FONT FACE=ARIAL  SIZE=0><b style = "color:#15428B"; >Faltas (Sin Revision) ['+total_sin_revision+']</b></FONT>';
						 chx.setText(lr);
					}
				 ...
				 if(total_sin_revisionretraso=="0" ){
					  ...
					  var ch1 = Ext.getCmp('c63');
						if (empty(ch1) != true) {
							lr='<a style ="color:#15428B; font: bold 8.5px tahoma,arial,verdana,sans-serif;">Retrasos </br>(Sin Revision) ['+total_sin_revisionretraso+']</a>';
							ch1.setText(lr);
						}
					...
					if (empty(chx) != true) {
						lr='<FONT FACE=ARIAL  SIZE=0><b style = "color:#15428B"; >Retrasos (Sin Revision) ['+total_sin_revisionretraso+']</b></FONT>';
						 chx.setText(lr);
					}
				 ...
				 if(bandejarevisor=="0"){
				  ...
				  if (empty(ch1) != true) {
					  lr='<a style ="color:#15428B; font: bold 8.5px tahoma,arial,verdana,sans-serif;">Bandeja </br>(Revisores) ['+bandejarevisor+']</a>';
					 ch1.setText(lr);
				  }
				  var chx = Ext.getCmp('Me9');
					...
					if (empty(chx) != true) {
						lr='<FONT FACE=ARIAL  SIZE=0><b style = "color:#15428B"; >Bandeja (Revisores) ['+bandejarevisor+']</b></FONT>';
						 chx.setText(lr);
					}
				 ...
				 if(total_EMD=="0"){
				  ...
				  if (empty(ch1) != true) {
					  lr='<a style ="color:#15428B; font: bold 8.5px tahoma,arial,verdana,sans-serif;">Pendientes E.M.D. ['+total_EMD+']</a>';
					 ch1.setText(lr);
				  }
				  var chx = Ext.getCmp('Me13');
					 ...
					 //if(borradorSinLeer=="0" && rechazadoSinLeer=="0"){
						if (empty(chx) != true) {
						lrx='<b style =color:#15428B><font size=1>Evaluación de Desempeño </font></b>';
						chx.setTitle(lrx);
						}
					...
					if (empty(chx) != true) {
						lr='<FONT FACE=ARIAL  SIZE=0><b style = "color:#15428B"; >Pendientes E.M.D. ['+total_EMD+']</b></FONT>';
						 chx.setText(lr);
					}
	...
	var lblsession = new Ext.form.Label({
			...
			'<table width="100%" HEIGHT="20%" border="0"  >  <tr><td height="0" style=" url(images/lcentro.png) no-repeat left center ">' +
							...
							<?php
								//$titlem='<a style ='.".'color:#15428B; font: bold 8px tahoma,arial,verdana,sans-serif;'.".'>'. $_SESSION['Nombresesion'] . ' ' . $_SESSION['Apellido1'].' </a>';
							$titlem="<FONT FACE=ARIAL  SIZE=1><b style = color:#15428B; >". $_SESSION['Nombresesion'] . " " . $_SESSION['Apellido1']."</b></FONT>";
	 ...
	 Ext.dsdata.PAmenu = new Ext.FormPanel(
	{
		...
		align: 'center',
		//height: 20,
		title:'<P ALIGN=right> <a href="DSlists/DSDatosUsuario.php"><img src="img/sesion16.png" border="1"/> <FONT FACE=ARIAL  SIZE=1 color="#15428B"> <?php echo $titlem="<FONT FACE=ARIAL  SIZE=1>". $_SESSION['Nombre1'] . " " . $_SESSION['App']."</FONT>"; ?> </font></a> | <a href="DSlists/DSConfirmarInicioSessionReseteado.php"><img src="img/reseteo16.png" border="1"/> <FONT FACE=ARIAL  SIZE=1 color="#15428B"> Cambio de Password </font></a> | <a href="DScerrarsesion.php"><img src="img/cerrar16.png" border="1"/> <FONT FACE=ARIAL  SIZE=1 color="#15428B"> Salir del Sistema </font> </a> | </P>',
	     collapsible: true,
		margins: '0 0 0 0',
		y:0,
    ...
    var viewport = new Ext.Viewport({
        ...
        new Ext.BoxComponent({
            ...
            title: '<b style =color:#15428B>Menu Principal </b>',
            split: true,
            width: 230,
			// height:200,
